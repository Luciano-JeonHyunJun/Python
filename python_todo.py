...
if __name__ == "__main__" :
	...
	enterTask = Label(gui, text = "너의 오늘 할일이 뭐야?", bg = "white")
	...
	Submit = Button(gui, text = "등록", fg = "#ffffff", bg = "#000000", command = insertTask)
	...
	taskNumber = Label(gui, text = "Delete Task Number", bg = "#ffffff")
